...
\begin{itemize}
  ...
  \item 12000 条 Markov 轨迹
  \item 五类估值 + 发现成本 0.018
  \item 最优停止 DP 生成停止轮次频率
\end{itemize}
\end{block}
\column{0.49\textwidth}
\begin{block}{完整实验规模}
...
\small
\begin{itemize}
  \item 最终 KL（$1/(t+1),1/\sqrt t,1/2$）：0.03752、0.00684、0.00519
  \item $1/2$ 最快，但尾部波动 0.00353
  \item $1/\sqrt t$ 的尾部波动仅 0.00019
\end{itemize}
\end{exampleblock}
\column{0.50\textwidth}
...
\midrule
$1/(t+1)$ & $0.03752\pm0.01698$ & 0.03765 & \textbf{0.00008}\\
$1/\sqrt t$ & $0.00684\pm0.00444$ & 0.00695 & 0.00019\\
$1/2$ & \textbf{$0.00519\pm0.00166$} & \textbf{0.00545} & 0.00353\\
\bottomrule
\end{tabular}
\end{table}
\begin{columns}[T,onlytextwidth]
