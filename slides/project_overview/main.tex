...
\begin{itemize}
  ...
  \item 复现报告：\texttt{deliverables/final\_report.pdf}
  \item 课程展示：\texttt{deliverables/project\_overview\_slides.pdf}
  \item 当前版本：\texttt{v0.6.0}
\end{itemize}
\vspace{0.8em}
\small
