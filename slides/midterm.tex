...
\begin{itemize}
  ...
  \item RQ2/3：$|\mathcal Q|=4,|\Theta|=6,T=6$
  \item 240 条训练、4000 条测试轨迹
  \item 固定种子：20260716
\end{itemize}
\end{block}
\end{columns}
...
\begin{enumerate}
  ...
  \item 在公开数据上缩减复现 Data-Bandit RQ1；
  \item 发现“自愿购买 vs. 强制选择”的建模缺口；
  \item 给出 IR 外部选项与鲁棒定价修正；
