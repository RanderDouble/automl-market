...
\midrule
$1/(t+1)$ & $0.03752\pm0.01698$ & 0.03754 & 0.00008 \\
$1/\sqrt t$ & $0.00684\pm0.00444$ & 0.00689 & 0.00019 \\
$1/2$ & $0.00519\pm0.00166$ & 0.00643 & 0.00353 \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{itemize}[leftmargin=*]
    ...
    \item 常数 $1/2$ 的尾部方差为 $0.00353$，是 $1/(t+1)$ 的 44 倍——虽然第 1000 轮的点估计最好（0.00519），但过程不稳定。批量 10 时尤其严重（平均最终 KL 约 0.1965，尾部标准差约 0.0488）。
